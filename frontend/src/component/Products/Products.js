...
const categories = ["Wall Decorations","Textile and Rugs", "Art and prints", "Storage items", "Curtains ans Blinds", "Plant and Pots","Handicrafts", "Other"];
...
const Products = () => {
    ...
    return (
        ...
        {loading ? <Loader />: (
            <Fragment>
            <MetaData title="Products - Art Vista" />
            ...
            <div className="products">
                ...
                {(filteredProducts !== undefined && filteredProducts.length === 0)? (<h1 style={{minHeight: "90vh"}}>PRODUCT NOT FOUND :(</h1>): <span></span>}
            </div>
